...
IETF_PTP = 'ietf-ptp'
IEEE1588_PTP = 'ieee1588-ptp'
IEEE802_DOT1CB_STREAM_IDENTIFICATION = 'ieee802-dot1cb-stream-identification'
IEEE802_DOT1CB_FRER = 'ieee802-dot1cb-frer'
MODEL_DICT = [IEEE802_DOT1Q_BRIDGE, IETF_INTERFACES, IEEE8021_MSTP, IEEE802_DOT1AB_LLDP, IEEE802_DOT1Q_FQTSS, IETF_PTP, IEEE1588_PTP,  IEEE802_DOT1CB_STREAM_IDENTIFICATION, IEEE802_DOT1CB_FRER]
...
IEEE1588_PTP_MODULE = '<ptp xmlns="urn:ieee:std:1588:yang:ieee1588-ptp"/>'
IEEE802_DOT1CB_STREAM_IDENTIFICATION_MODULE = '<stream-identity xmlns="urn:ieee:std:802.1Q:yang:ieee802-dot1cb-stream-identification"/>'
IEEE802_DOT1CB_FRER_MODULE = '<frer xmlns="urn:ieee:std:802.1Q:yang:ieee802-dot1cb-frer"/>'
...
NS_DICT = {IEEE802_DOT1Q_BRIDGE : IEEE802_DOT1Q_BRIDGE_MODULE,
           ...
           IEEE1588_PTP : IEEE1588_PTP_MODULE,
           IEEE802_DOT1CB_STREAM_IDENTIFICATION : IEEE802_DOT1CB_STREAM_IDENTIFICATION_MODULE,
           IEEE802_DOT1CB_FRER: IEEE802_DOT1CB_FRER_MODULE  
}

# Indicator if UNDO config is required after edit-config operation (used for modules that are without a top level container)
UNDO_CONF_DICT = {
        IEEE802_DOT1Q_BRIDGE : False,
        IETF_INTERFACES : False,
        IEEE8021_MSTP : False,
        IEEE802_DOT1AB_LLDP : False,
        IEEE802_DOT1Q_FQTSS : False,
        IETF_PTP : False,
        IEEE1588_PTP : False,
        IEEE802_DOT1CB_STREAM_IDENTIFICATION : True,
        IEEE802_DOT1CB_FRER : True
}
